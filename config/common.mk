...
PRODUCT_COPY_FILES += \
    vendor/pb/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/android.software.nfc.beam.xml
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/pb/overlay/no-rro
PRODUCT_PACKAGE_OVERLAYS += \
    vendor/pb/overlay/common \
    vendor/pb/overlay/no-rro
